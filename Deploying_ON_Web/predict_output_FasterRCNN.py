...
model_path = "C:/Users/XMainL/PycharmProjects/DeepLearning/Deploying_ON_Web/logs/best_epoch_weights.pth"
# model = frcnn.FRCNN()
...
def get_output(image):
    ...
    r_image.show()
    r_image.save("C:/Users/XMainL/PycharmProjects/DeepLearning/Deploying_ON_Web/static/saved_imgs/img.jpg")
    return r_image
